...
const Header = () => {
  return (
    <header className="vertical-center fixed top-0 right-0 left-0 z-50 min-h-[6.125rem] justify-between gap-x-10 bg-white px-6 py-6 shadow-[0_4px_9.3px_0px_rgba(0,0,0,0.05)] max-md:flex-wrap max-md:gap-y-4">
